...
const Navbar = () => {
  return (
    <div className='fixed z-50 w-full bottom-0 md:left-1/2 md:-translate-x-1/2 md:bottom-10 bg-gradient-to-r from-slate-800 to-violet-950 md:max-w-lg py-2 px-12 md:rounded-full'>
