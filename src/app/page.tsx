      ...
      <main className="w-full flex overflow-hidden relative">
        ...
        <div className="z-10 flex flex-col md:flex-row-reverse md:justify-between md:items-center items-center justify-start text-center md:text-left gap-3 md:gap-12 relative max-w-7xl mx-auto px-4 w-full h-full py-0 md:pt-16">
          ...
          <div className="flex justify-center py-1 scale-[0.7] md:scale-100">
            <div className="relative p-2 border hidden md:flex border-white/10 bg-white/5 backdrop-blur-sm shadow-2xl">
              <div>
                <Image
                  src="/profile.jpeg"
                  width={400}
          ...
          <div className="flex pt-16 md:pt-0 flex-col gap-3 md:gap-6">
            {/* Top Text Group */}
            <div className="space-y-1 md:space-y-2 animate-fade-in-up">
              <h1 className="text-5xl sm:text-5xl uppercase flex flex-col gap-4 md:text-5xl lg:text-6xl font-bold font-oswald tracking-tighter text-white drop-shadow-2xl">
            ...
            <div className="space-y-3 md:space-y-4 animate-fade-in-up delay-200">
              <h2 className="text-lg md:text-lg max-w-md font-light text-gray-400 tracking-wide">
                {t.home.subtitle}
              </h2>

              <div className="flex flex-row gap-2 md:gap-3 md:justify-start justify-center items-center">
                <a
                  href="/projects"
