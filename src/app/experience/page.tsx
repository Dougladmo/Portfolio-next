  ...
  return (
    <>
      <main className="w-full flex min-h-screen overflow-hidden relative">
        <div className="max-w-6xl mx-auto w-full px-4 py-20 md:py-16">
          ...
          <div className="mb-16 text-center">
            ...
            <p className="text-gray-400 text-lg md:text-xl">{t.experience.subtitle}</p>
          </div>
          ...
          <div className="mb-20">
            ...
            <div className="relative p-8 bg-white/5 border border-white/10 rounded-2xl backdrop-blur-md hover:bg-white/10 transition-all duration-300 shadow-2xl">
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  <p className="text-white font-bold text-2xl mb-2">{t.experience.education.degree}</p>
                  <p className="text-blue-400 font-semibold text-xl">{t.experience.education.university}</p>
                  <p className="text-gray-400 text-base mt-2">{t.experience.education.location}</p>
                </div>
                ...
                <CometCard key={index} rotateDepth={12} translateDepth={12}>
                  <div className="relative p-6 bg-[#1F2121] border-0 rounded-2xl h-full min-h-[140px] flex flex-col justify-between">
                    <div>
                      ...
                      <p className="text-white font-semibold text-lg mb-2">{cert.title}</p>
                      <p className="text-gray-400 text-base mb-1">{cert.institution}</p>
