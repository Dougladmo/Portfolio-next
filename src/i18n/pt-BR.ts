...
export const ptBR: Translations = {
  ...
  projects: {
    ...
    cards: [
      {
        title: "NoBuggy",
        description: "Site institucional desenvolvido para apresentar a NoBuggy como empresa de soluções digitais, com forte foco em performance, identidade visual e experiência do usuário.",
        stack: ["React", "Tailwind CSS", "Framer Motion", "GSAP", "AWS S3"],
        category: "Site Institucional",
      },
      {
        title: "AComportamental",
        description: "Site institucional desenvolvido em React puro, com foco em simplicidade, clareza e comunicação direta com o público da organização.",
        stack: ["React", "JavaScript"],
        category: "Site Institucional",
      },
      {
        title: "BeFest",
        description: "Plataforma completa de agendamento e gestão de festas, desenvolvida como um sistema full stack com IA (GPT) para planejamento de eventos e pagamentos via Mercado Pago.",
      ...
      {
        title: "Recicle Aqui",
        description: "Projeto desenvolvido durante um hackathon universitário (Semana Ubitla), com prazo de aproximadamente 3 dias de desenvolvimento. Conquistou Top 1 da competição.",
        stack: ["React", "Tailwind CSS", "Node.js", "PostgreSQL"],
        category: "Hackathon",
      },
      {
        title: "SofEmpire",
        description: "Sistema completo de gestão de salões e profissionais da beleza, desenvolvido sob demanda para um cliente do setor. Inclui precificação automática e gestão financeira completa.",
        stack: ["React", "Node.js", "PostgreSQL"],
        category: "Sistema de Gestão",
      },
      {
        title: "SolarKit",
        description: "Plataforma de vendas e simulação de kits de energia solar. Landing page dinâmica com simulação de consumo e recomendação automática de kits com painel administrativo.",
      ...
      {
        title: "Farmfy",
        description: "Aplicativo mobile voltado para o agronegócio, criado para centralizar informações estratégicas e apoiar a tomada de decisão no dia a dia do produtor rural.",
        stack: ["React Native", "Node.js", "Python", "Django", "PostgreSQL"],
        category: "App Mobile",
      },
    ],
  },
